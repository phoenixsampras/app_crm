<?php
    ...
    {
        $sWhere = "WHERE (";
        $sWhere .= "pedido ILIKE '%".pg_escape_string( $_GET['search']['value'] )."%'  or " ;
        $sWhere .= "cliente ILIKE '%".pg_escape_string( $_GET['search']['value'] )."%'  ";
        $sWhere .= ")";
    }

    // Variable para buscar un pedido
    if ($_REQUEST['soid'] !== 'undefined' && $_REQUEST['soid'] > 0 ) {
        $soid = $_REQUEST['soid'];
    } else {
        $soid = false;
    }
    ...
    if ($soid) {
        $sWhere = "WHERE (";
        $sWhere .= " soid = '".pg_escape_string( $_REQUEST['soid'] )."' " ;
        $sWhere .= ")";
    }
