    ...
    if ($username && $password){
        ...
        if ($uid){
            ...
            // } else {
                ...
                echo $_GET['callback'].'({"login": '.$uid.',"vendedor":"false","ciudad":"' . $rmDatosCliente[0]['ew_zonas_cliente_id'][1] . '", "partner_id": '. $rmDatosCliente[0]['id'] .','.$user_data.','.$rmCompany.',"location_id":"12","location_dest_id":"xx","company_id":"1","picking_type_id":"3"})';
            }
            // print_r($rmDatosUsuario);
